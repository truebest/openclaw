...
export async function resolveGatewayRuntimeConfig(params: {
  ...
  const modelProxyConfig = params.cfg.gateway?.http?.endpoints?.modelProxy;
  const modelProxyEnabled = params.modelProxyEnabled ?? modelProxyConfig?.enabled ?? false;
  ...
  return {
    ...
    modelProxyConfig: modelProxyConfig
      ? { ...modelProxyConfig, enabled: modelProxyEnabled }
      : undefined,
